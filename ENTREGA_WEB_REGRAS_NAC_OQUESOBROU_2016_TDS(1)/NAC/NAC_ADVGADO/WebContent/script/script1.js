...
function bannerLogo1(){
	document.getElementById("banner1").src = "../img/banner_03.jpg";
	setTimeout("bannerLogo2()", 2000);
}


function bannerLogo2(){
	document.getElementById("banner1").src = "../img/banner_03.jpg";
	setTimeout("bannerLogo3()", 2000);
}

function bannerLogo3(){
	document.getElementById("banner1").src = "../img/banner4.jpg";
	setTimeout("bannerLogo1()", 2000);
}

function alerta(){
	alert("Despesas Consultadas");
	
//alerta que aparecera após clicar no botão
}

//apartir daqui sera o botão
...
function alerta5(){
	alert("Honorários Registrados com Sucesso!");
}
...
function Honorario()
{
location.href="ConsultaHonorario.html"
}
...
function Calculo() {
	...
	var quantidade = parseFloat(document.newParcela.quantidade.value);
	var calcular = valor*quantidade;
	document.newParcela.total.value = calcular;
}

function somaDespesa() {
	var valor = parseFloat(document.newDespesa.valor.value);
	var quantidade = parseFloat(document.newDespesa.quantidade.value);
	var calcular = valor*quantidade;
	document.newDespesa.total.value = calcular;
}